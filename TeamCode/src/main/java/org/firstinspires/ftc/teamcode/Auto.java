...
public class Auto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //Resets Encoders
        robot.D_LF_M.setMode(DcMotor.RunMode.RESET_ENCODERS);
        robot.D_LB_M.setMode(DcMotor.RunMode.RESET_ENCODERS);
        robot.D_RF_M.setMode(DcMotor.RunMode.RESET_ENCODERS);
        robot.D_LF_M.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
    ...
    public void stop_motors(){
        robot.D_LF_M.setPower(0);
        robot.D_LB_M.setPower(0);
        robot.D_RF_M.setPower(0);
        robot.D_RB_M.setPower(0);
    }
    //Displays useful telementry onto DS phone
    public void telemetry(){
        telemetry.addData("E1", robot.D_LF_M.getCurrentPosition() * -1);
        telemetry.addData("E2", robot.D_LB_M.getCurrentPosition());
        telemetry.addData("E3", robot.D_RF_M.getCurrentPosition());
    ...
    public void Movement() {
        ...
        int E1 = robot.D_LF_M.getCurrentPosition() * -1;
        int E2 = robot.D_LB_M.getCurrentPosition();
        int E3 = robot.D_RF_M.getCurrentPosition() * -1;
...
*/
    ...
    public void MotorEquation() {
        ...
        //Sets motors
        robot.D_LF_M.setPower((Speed_Setpoint*(LF_Distance/Highest_Motor_Power)));
        robot.D_LB_M.setPower((Speed_Setpoint*(LB_Distance/Highest_Motor_Power)));
        robot.D_RF_M.setPower((Speed_Setpoint*(RF_Distance/Highest_Motor_Power)));
        robot.D_RB_M.setPower((Speed_Setpoint*(RB_Distance/Highest_Motor_Power)));
    }
    //Runs Encoders
