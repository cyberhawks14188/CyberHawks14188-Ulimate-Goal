...
@Autonomous
//Sets name
public class Test_Movement_Program extends LinearOpMode {
...
*/
        ...
        Distance = Math.abs((Math.sqrt(Math.pow(Y_EndSetpoint-Last_Y_EndSetpoint, 2) + (Math.pow(X_EndSetpoint-Last_X_EndSetpoint, 2)))));
